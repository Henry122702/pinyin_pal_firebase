...
class ObjectsVocabTable2 extends StatefulWidget {
  const ObjectsVocabTable2({super.key});

  @override
  State<ObjectsVocabTable2> createState() => _ObjectsVocabTable2State();
}

class _ObjectsVocabTable2State extends State<ObjectsVocabTable2> {
  @override
