...
class ObjectsVocabTable extends StatefulWidget {
  const ObjectsVocabTable({super.key});

  @override
  State<ObjectsVocabTable> createState() => _ObjectsVocabTableState();
}

class _ObjectsVocabTableState extends State<ObjectsVocabTable> {
  @override
